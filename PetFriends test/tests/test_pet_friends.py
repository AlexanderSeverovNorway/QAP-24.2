...
@pytest.mark.api
def test_add_new_pet_with_valid_data(get_key, name='Барбос', animal_type='терьер', age='49',
...
@pytest.mark.api
def test_add_new_pet_with_valid_data_without_photo(get_key, name='Jeronimo', animal_type='supermen', age='77'):
...
@pytest.mark.api
def test_add_new_pet_with_unvalid_auth_key_without_photo(get_key, name='Tom', animal_type='dog', age='5'):
...
@pytest.mark.api
@pytest.mark.skip(reason="Баг проекта - <https://petfriends.skillfactory.ru/>")
def test_add_new_pet_without_photo_with_unvalid_name(get_key, name='MjIeBfj0TO7VAcxkp', animal_type='', age='6'):
...
@pytest.mark.api
@pytest.mark.skip(reason="Баг проекта - <https://petfriends.skillfactory.ru/>")
def test_add_new_pet_without_photo_with_unvalid_animal_type(get_key, name='Том', animal_type='MjIeBfj0TOyfr', age='6'):
...
@pytest.mark.api
@pytest.mark.skip(reason="Баг проекта - <https://petfriends.skillfactory.ru/>")
def test_add_new_pet_without_photo_with_unvalid_age(get_key, name='Том', animal_type='кот', age='-68689676'):
...
@pytest.mark.api
def test_unsuccessful_add_new_pet(get_key, name='Bil', animal_type='hen', age='9', pet_photo='images/cat1.jpg'):
